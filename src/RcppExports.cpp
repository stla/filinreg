...
RcppExport SEXP _filinreg_f_cauchy(SEXP centersSEXP, SEXP XISEXP, SEXP XmISEXP, SEXP yISEXP, SEXP ymISEXP, SEXP MSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type centers(centersSEXP);
...
RcppExport SEXP _filinreg_f_logistic(SEXP centersSEXP, SEXP XISEXP, SEXP XmISEXP, SEXP yISEXP, SEXP ymISEXP, SEXP MSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type centers(centersSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_filinreg_f_cauchy", (DL_FUNC) &_filinreg_f_cauchy, 7},
    {"_filinreg_f_student", (DL_FUNC) &_filinreg_f_student, 8},
    {"_filinreg_f_logistic", (DL_FUNC) &_filinreg_f_logistic, 7},
    {NULL, NULL, 0}
};
